...
function VisionPage() {
  ...
  return (
    <PageShell
      ...
      intro="Faire de la fonction Construction et Gestion des Actifs un centre d'excellence capable de soutenir la croissance de LIFA, de protéger durablement ses investissements et d'améliorer la vie des locataires."
    >
